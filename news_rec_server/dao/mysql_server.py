...
from conf.dao_config import loginfo_db_name, user_info_db_name, contest_loginfo_db_name, mysql_username, mysql_passwd, mysql_hostname, mysql_port


class MysqlServer(object):
    def __init__(self, username=mysql_username, passwd=mysql_passwd, hostname=mysql_hostname, port=mysql_port, \

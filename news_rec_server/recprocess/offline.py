...
# from recall.rec_recall import RecRecall
...
class OfflineServer(object):
    ...
    def rec_list_to_redis(self):
        """个性化推荐列表，千人千面
        """
        self.rec_recall.update_hot_value()
        # 将新闻的推荐模板添加到redis中
        self.rec_recall.group_cate_for_news_list_to_redis()        
        print("a rec list are saved into redis.....")

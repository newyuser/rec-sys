import sys
sys.path.append("/home/harry/fun-rec/codes/news_recsys/news_rec_server/conf")
sys.path.append("/home/harry/fun-rec/codes/news_recsys/news_rec_server/")
import json
import time
import threading
from dao_config import cate_dict, user_group_dict
from proj_path import bad_case_news_log_path
...
class OnlineServer(object):
    ...
    def _set_user_group(self):
        ...
        """
        self.user_group = user_group_dict
...
if __name__ == "__main__":
    ...
    # oneline_server.get_hot_list("462803346")
    oneline_server.test()
...
parser.add_argument('--yaml_path',
                    default='/home/harry/fun-rec/codes/news_recsys/news_rec_server/recprocess/rank/examples/set_para/deepfm_ppnet_news.yaml',
                    required=False)
...
if __name__ == '__main__':
    ...
    history = run_deepfm_ppnet.run(train_inputs, train_labels, test_inputs, test_labels, features_columns, args)

    df = pd.DataFrame(history.history)
    df.to_csv('deepfm_ppnet.csv')
...
class RegionRecall(object):
    ...
    def read_and_process_data(self):
        ...
        self.train_log_df = pd.read_csv(self.log_data_path, sep='\t')
        self.train_log_df.columns = log_columns
        self.doc_info_df = pd.read_csv(self.doc_info_path, sep='\t')
        self.doc_info_df.columns = doc_columns
        self.user_info_df = pd.read_csv(self.user_info_path, sep='\t')
        self.user_info_df = user_columns
        # 删除重复数据
